...
void main() async {
  ...
  // Now you can use the box for operations
  var myBox = Hive.box('myBox');
  // Perform operations on 'myBox' here
}
...
class HiveLocalStorage extends LocalStorage {
 ...
 static Future<void> _persistSession(String persistSessionString) async {
    ...
    // Perform the session persistence
    await Hive.box(_hiveBoxName).put(supabasePersistSessionKey, persistSessionString);
  }
